...
now a measured extremal case with stable reference profiles.
...
The present extremal case is part of the result.
...
and the remaining extremal case is not whether the engine exists, but what
...
Using the balanced operating profile window (`L = 3`):
...
layer, and a higher-divisor-triggered long-horizon controller target.
