...
![Exemplar prime gaps where the score winner and the arithmetic winner coincide](./exemplar_gap_profiles.png)
...
admissible composite, while nothing strictly simpler appears after the winner
before the gap closes. That extra organization is what turns a directional bias
into a complete winner law.

![Winner mass concentrated in the low-divisor, left-side corner](./winner_heatmap.png)
