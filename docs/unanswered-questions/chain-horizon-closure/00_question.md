...
**Mine the least-factor frontier of false chain nodes and determine whether its maximum is governed by a PGS-visible invariant of the anchor, shadow seed, chain gaps, residues, or chamber state.**
